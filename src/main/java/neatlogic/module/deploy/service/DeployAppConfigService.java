...
public interface DeployAppConfigService {
    ...
    List<Long> getCmdbHasEnvAppModuleIdListByAppSystemIdAndModuleIdList(Long appSystemId, List<Long> appModuleIdList);
    ...
    List<DeployAppModuleEnvVo> getCmdbDeployAppModuleEnvListByAppSystemId(Long appSystemId);

    List<DeployAppModuleEnvVo> getDeployAppModuleEnvListByAppSystemId(Long appSystemId);

    List<DeployAppModuleEnvVo> getCmdbDeployAppModuleEnvListByAppSystemIdAndAppModuleIdList(Long appSystemId, List<Long> appModuleIdList);
    ...
    List<DeployAppEnvironmentVo> getCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvId(Long appSystemId, Long appModuleId, List<Long> envIdList);
