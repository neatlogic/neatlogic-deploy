...
@Service
public class TestDeployScheduleApi extends PrivateApiComponentBase {
    @Override
    ...
    public Object myDoService(JSONObject paramObj) throws Exception {
        ...
        scheduleCrossoverService.scheduleTest(DeployJobScheduleJob.class.getName(), jobUuid, "private");
        return null;
    }

    @Override
    public String getToken() {
        return "deploy/job/test";
    }
}
