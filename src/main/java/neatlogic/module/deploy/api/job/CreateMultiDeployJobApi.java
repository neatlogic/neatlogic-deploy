...
public class CreateMultiDeployJobApi extends PrivateApiComponentBase {
    ...
    @Input({
            ...
            @Param(name = "appSystemAbbrName", type = ApiParamType.STRING, desc = "term.cmdb.sysname", help = "term.cmdb.appsystemabbrname"),
            ...
            @Param(name = "envName", type = ApiParamType.STRING, desc = "term.cmdb.envname", help = "term.cmdb.envname"),
