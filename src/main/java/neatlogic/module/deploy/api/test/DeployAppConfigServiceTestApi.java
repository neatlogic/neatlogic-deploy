...
//                    System.out.println("envList.size() = " + envList.size() + ", count = " + count);
    ...
    private void getCmdbEnvListByAppSystemIdAndModuleIdTest() {
        getCmdbEnvListByAppSystemIdAndModuleIdTestForAppSystemId();
        getCmdbEnvListByAppSystemIdAndModuleIdTestForAppModuleId();
    }

    private void getCmdbEnvListByAppSystemIdAndModuleIdTestForAppSystemId() {
        IResourceCrossoverMapper resourceCrossoverMapper = CrossoverServiceFactory.getApi(IResourceCrossoverMapper.class);
        try {
            String sql = deployResourceBuildSqlService.buildGetCmdbEnvListByAppSystemIdAndModuleIdSql(-1L, -1L);
...
//                    System.out.println("appModuleId = " + appModuleId);
                    ...
                    List<DeployAppEnvironmentVo> envList = deployAppConfigService.getCmdbEnvListByAppSystemIdAndModuleId(appSystemId, appModuleId);
//                    System.out.println("envList = " + JSONObject.toJSONString(envList));
                    if (envList == null || envList.isEmpty()) {
                        JSONObject itemObj = new JSONObject(true);
                        itemObj.put("envList", envList);
                        itemObj.put("count", count);
    ...
    private void getCmdbEnvListByAppSystemIdAndModuleIdTestForAppModuleId() {
        IResourceCrossoverMapper resourceCrossoverMapper = CrossoverServiceFactory.getApi(IResourceCrossoverMapper.class);
        try {
            String sql = deployResourceBuildSqlService.buildGetCmdbEnvListByAppSystemIdAndModuleIdSql(-1L, -1L);
//            System.out.println("sql = " + sql);
...
//                    System.out.println("count = " + count);
                    ...
                    String appSystemSql = deployResourceBuildSqlService.buildGetCmdbEnvListByAppSystemIdAndModuleIdSql(null, appModuleId);
...
//                    System.out.println("moduleEnvList = " + JSONObject.toJSONString(moduleEnvList));
                    ...
                    List<Long> idList = deployAppConfigService.getCmdbHasEnvAppModuleIdListByAppSystemIdAndModuleIdList(appSystemId, appModuleIdList);
...
//                    System.out.println("count = " + count);
                    Long appSystemId = null;
                    String appSystemSql = deployResourceBuildSqlService.buildGetCmdbHasEnvAppModuleIdListByAppSystemIdAndModuleIdListSql(null, List.of(appModuleId));
//                    System.out.println("appSystemSql = " + appSystemSql);
                    String groupByAppSystemSql = buildGroupBySql(appSystemSql, new Column("cientity_APP.id"), true);
//                    System.out.println("groupByAppSystemSql = " + groupByAppSystemSql);
                    List<Map<String, Object>> appSystemMapList = resourceCrossoverMapper.getMapListBySql(groupByAppSystemSql);
...
//                    System.out.println("appSystemId = " + appSystemId);
                    List<Long> idList = deployAppConfigService.getCmdbHasEnvAppModuleIdListByAppSystemIdAndModuleIdList(appSystemId, List.of(appModuleId));
//                    System.out.println("idList = " + JSONObject.toJSONString(idList));
                    if (idList == null || idList.isEmpty()) {
                        JSONObject itemObj = new JSONObject(true);
                        itemObj.put("idList", idList);
...
//                    System.out.println("moduleEnvList = " + JSONObject.toJSONString(moduleEnvList));
    ...
    private void getCmdbDeployAppModuleEnvListByAppSystemIdAndModuleIdTest() {
        getCmdbDeployAppModuleEnvListByAppSystemIdAndModuleIdTestForAppSystemId();
        getCmdbDeployAppModuleEnvListByAppSystemIdAndModuleIdTestForAppModuleId();
    }

    private void getCmdbDeployAppModuleEnvListByAppSystemIdAndModuleIdTestForAppSystemId() {
        IResourceCrossoverMapper resourceCrossoverMapper = CrossoverServiceFactory.getApi(IResourceCrossoverMapper.class);
        try {
            String sql = deployResourceBuildSqlService.buildGetCmdbDeployAppModuleEnvListByAppSystemIdAndModuleIdSql(-1L, -1L);
//            System.out.println("sql = " + sql);
            Column groupedColumn = new Column("cientity_APP.id");
            String groupBySql = buildGroupBySql(sql, groupedColumn);
//            System.out.println("groupBySql = " + groupBySql);
...
//                    System.out.println("appModuleId = " + appModuleId);
                    List<AppEnvironmentVo> envList = deployAppConfigService.getCmdbDeployAppModuleEnvListByAppSystemIdAndModuleId(appSystemId, appModuleId);
//                    System.out.println("envList = " + JSONObject.toJSONString(envList));
                    if (envList == null || envList.isEmpty()) {
                        JSONObject itemObj = new JSONObject(true);
                        itemObj.put("envList", envList);
    ...
    private void getCmdbDeployAppModuleEnvListByAppSystemIdAndModuleIdTestForAppModuleId() {
        IResourceCrossoverMapper resourceCrossoverMapper = CrossoverServiceFactory.getApi(IResourceCrossoverMapper.class);
        try {
            String sql = deployResourceBuildSqlService.buildGetCmdbDeployAppModuleEnvListByAppSystemIdAndModuleIdSql(-1L, -1L);
//            System.out.println("sql = " + sql);
...
//                    System.out.println("count = " + count);
                    Long appSystemId = null;
                    String appSystemSql = deployResourceBuildSqlService.buildGetCmdbDeployAppModuleEnvListByAppSystemIdAndModuleIdSql(null, appModuleId);
//                    System.out.println("appSystemSql = " + appSystemSql);
                    String groupByAppSystemSql = buildGroupBySql(appSystemSql, new Column("cientity_APP.id"), true);
//                    System.out.println("groupByAppSystemSql = " + groupByAppSystemSql);
                    List<Map<String, Object>> appSystemMapList = resourceCrossoverMapper.getMapListBySql(groupByAppSystemSql);
...
//                    System.out.println("envList = " + JSONObject.toJSONString(envList));
    ...
    private void getCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdTest() {
        getCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdTestForAppSystemId();
        getCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdTestForAppModuleId();
        getCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdTestForEnvIdList();
    }

    private void getCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdTestForAppSystemId() {
        IResourceCrossoverMapper resourceCrossoverMapper = CrossoverServiceFactory.getApi(IResourceCrossoverMapper.class);
        try {
            String sql = deployResourceBuildSqlService.buildGetCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdSql(-1L, -1L, List.of(-1L));
//            System.out.println("sql = " + sql);
            Column groupedColumn = new Column("cientity_APP.id");
            String groupBySql = buildGroupBySql(sql, groupedColumn);
//            System.out.println("groupBySql = " + groupBySql);
                    ...
                    if (moduleEnvList != null) {
                        for (DeployAppModuleEnvVo moduleEnvVo : moduleEnvList) {
                            if (moduleEnvVo != null && moduleEnvVo.getId() != null && moduleEnvVo.getEnvList() != null && !moduleEnvVo.getEnvList().isEmpty()) {
                                appModuleId = moduleEnvVo.getId();
                                envId = moduleEnvVo.getEnvList().get(0).getEnvId();
                                break;
                            }
                        }
                    }
...
//                    System.out.println("envId = " + envId);
                    if (appModuleId == null || envId == null) {
                        ...
                        itemObj.put("appSystemId", appSystemId);
                        itemObj.put("appModuleId", appModuleId);
                        itemObj.put("envIdList", envId == null ? null : List.of(envId));
                        itemObj.put("groupedColumn", groupedColumn.toString());
                        logger.info(itemObj.toJSONString());
                        continue;
                    }
                    List<DeployAppEnvironmentVo> envList = deployAppConfigService.getCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvId(appSystemId, appModuleId, List.of(envId));
//                    System.out.println("envList = " + JSONObject.toJSONString(envList));
                    if (envList == null || envList.isEmpty()) {
                        JSONObject itemObj = new JSONObject(true);
                        itemObj.put("envList", envList);
                        ...
                        itemObj.put("appSystemId", appSystemId);
                        itemObj.put("appModuleId", appModuleId);
                        itemObj.put("envIdList", List.of(envId));
                        itemObj.put("groupedColumn", groupedColumn.toString());
                        logger.info(itemObj.toJSONString());
                    }
                }
    ...
    private void getCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdTestForAppModuleId() {
        IResourceCrossoverMapper resourceCrossoverMapper = CrossoverServiceFactory.getApi(IResourceCrossoverMapper.class);
        try {
            String sql = deployResourceBuildSqlService.buildGetCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdSql(-1L, -1L, List.of(-1L));
//            System.out.println("sql = " + sql);
...
//                    System.out.println("count = " + count);
                    Long appSystemId = null;
                    String appSystemSql = deployResourceBuildSqlService.buildGetCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdSql(null, appModuleId, null);
//                    System.out.println("appSystemSql = " + appSystemSql);
                    String groupByAppSystemSql = buildGroupBySql(appSystemSql, new Column("cientity_APP.id"), true);
//                    System.out.println("groupByAppSystemSql = " + groupByAppSystemSql);
                    List<Map<String, Object>> appSystemMapList = resourceCrossoverMapper.getMapListBySql(groupByAppSystemSql);
...
//                    System.out.println("appSystemId = " + appSystemId);
                    Long envId = null;
                    if (appSystemId != null) {
                        List<AppEnvironmentVo> appEnvironmentList = deployAppConfigService.getCmdbDeployAppModuleEnvListByAppSystemIdAndModuleId(appSystemId, appModuleId);
                        if (appEnvironmentList != null && !appEnvironmentList.isEmpty()) {
                            envId = appEnvironmentList.get(0).getEnvId();
                        }
                    }
//                    System.out.println("envId = " + envId);
                    if (appSystemId == null || envId == null) {
                        JSONObject itemObj = new JSONObject(true);
                        itemObj.put("count", count);
                        itemObj.put("appSystemId", appSystemId);
                        itemObj.put("appModuleId", appModuleId);
...
//                    System.out.println("envList = " + JSONObject.toJSONString(envList));
    ...
    private void getCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdTestForEnvIdList() {
        IResourceCrossoverMapper resourceCrossoverMapper = CrossoverServiceFactory.getApi(IResourceCrossoverMapper.class);
        try {
            String sql = deployResourceBuildSqlService.buildGetCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListByAppSystemIdAndAppModuleIdAndEnvIdSql(-1L, -1L, List.of(-1L));
//            System.out.println("sql = " + sql);
...
//                    System.out.println("envList = " + JSONObject.toJSONString(envList));
                    if (envList == null || envList.isEmpty()) {
                        ...
                        itemObj.put("appModuleId", appModuleId);
                        itemObj.put("envIdList", List.of(envId));
                        itemObj.put("groupedColumn", "envIdList");
                        logger.info(itemObj.toJSONString());
                    }
                }
            }
