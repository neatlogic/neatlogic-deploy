...
public interface DeploySqlMapper extends IDeploySqlCrossoverMapper {
    ...
    List<String> getDeployJobSqlStatusList(@Param("jobId") Long jobId, @Param("jobPhaseName") String name,@Param("runnerMapId")Long runnerMapId, @Param("statusList")List<String> statusList);
    ...
    void updateDeploySqlStatusByJobIdAndPhaseId(@Param("jobId") Long jobId, @Param("phaseId") Long phaseId, @Param("status") String status);
}
