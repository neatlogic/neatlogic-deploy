...
public interface DeployAppConfigMapper extends IDeployAppConfigCrossoverMapper {
    ...
    List<DeployAppEnvironmentVo> getDeployAppEnvListBySql(String sql);
    ...
    List<DeployAppEnvironmentVo> getEnvListBySql(String sql);
    ...
    List<DeployAppConfigVo> getAppConfigListByAppSystemIdList(List<Long> list);
    ...
    List<DeployAppModuleEnvVo> getDeployAppModuleEnvListBySql(String sql);
    ...
    List<DeployAppModuleEnvVo> getDeployAppModuleEnvListIncludeEnvIdListBySql(String sql);
    ...
    List<AppEnvironmentVo> getAppEnvListBySql(String sql);
    ...
    List<DeployAppEnvironmentVo> getCmdbAppConfigEnvListIncludeDBCSchemaListAndAutoCfgKeyListBySql(String sql);
